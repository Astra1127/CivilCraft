...
export function SiteFooter() {
  ...
  return (
    <footer className="relative mt-16 border-t-2 border-border bg-card">
      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
        ...
        {(() => {
          ...
          return (
            <div className="min-w-0 md:text-right">
              ...
              {links.length ? (
                <ul className="mt-3 flex flex-wrap gap-4 text-sm md:justify-end">
                  {links.map((k) => (
