        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-white font-bold text-lg tracking-tight">Super Administration HQ</h2>
              <p className="text-earth-300/70 text-xs font-mono">System Owner  ·  Full Access Control</p>
            </div>
          </div>
        ...
        {statCards.map((s) => {
          ...
          return (
            ...
            >
              ...
              <div className={`flex items-center gap-1.5 text-[10px] font-mono text-cyber-green`}>
        ...
        <div className="space-y-5">
          <BlueprintCard className="p-5 bg-earth-800 border-earth-600/40">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <h3 className="text-sm font-bold text-earth-200 tracking-tight">Super Admin Controls</h3>
            </div>
            <div className="space-y-2">
              {[
                { label: 'Manage All Users', icon: Users, page: 'users', blue: true },
                { label: 'Platform Settings', icon: Settings, page: 'settings', blue: false },
                { label: 'Global Analytics', icon: BarChart3, page: 'analytics', blue: false },
              ].map((btn) => {
                const Icon = btn.icon;
                return (
                  <button
